...
export const PackageIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    className={className}
  >
    <path d="M16.5 9.4 9.55 4.24" />
    <path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 18v-8Z" />
